...
from Suricatoos.common_func import create_inappnotification, get_hackerone_key_username
from Suricatoos.definitions import PROJECT_LEVEL_NOTIFICATION, HACKERONE_ALLOWED_ASSET_TYPES
from Suricatoos.celery import app
from Suricatoos.database_utils import bulk_import_targets
		...
		if program_details:
			...
			try:
				...
				for scope in scopes:
					...
					# we need to filter the scope that are supported by Suricatoos now
