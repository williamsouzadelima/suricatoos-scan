...
from Suricatoos.validators import validate_short_name
    ...
    discord_hook_url = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                "class": "form-control h-100",
                "id": "discord_hook_url",
                "placeholder": "https://discord.com/api/webhooks/<channel-id>/<webhook-token>",
            },
            render_value=True
        ))
...
class ReportForm(forms.ModelForm):
    ...
    show_suricatoos_banner = forms.BooleanField(
        required=False,
        widget=forms.CheckboxInput(
            attrs={
                "class": "form-check-input",
                "id": "show_suricatoos_banner",
            }))
    ...
    def set_value(self, key):
        ...
        self.initial['show_suricatoos_banner'] = key.show_suricatoos_banner
    ...
    def set_initial(self):
        self.initial['show_suricatoos_banner'] = True
